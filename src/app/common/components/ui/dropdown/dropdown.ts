import { Component, Input, Output, EventEmitter, OnInit, HostListener, ElementRef, forwardRef, HostBinding, ViewChild } from '@angular/core';
...
export class FiizDropDownComponent extends EntityCollectionComponentBase implements ControlValueAccessor, OnInit {
    ...
    @Input('type') dropdownType!:string;
    ...
    public toggle() {
      ...
      if( this.showDropDowns && this.searchInput ){
