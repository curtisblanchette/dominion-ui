...
import { getButtonsForRole, getSupportButtons } from './dashboard-buttons';
...
export class DashboardComponent implements OnInit {
  ...
  public quickStartMenu:Array<Object> = [];
  public supportMenu:Array<Object> = getSupportButtons();
  ...
  constructor(
    ...
    this.store.select(fromLogin.selectLoginUser).subscribe((user: any) => {
      if (user) {
        ...
        this.quickStartMenu = getButtonsForRole('agent');
      }
    });
  }
